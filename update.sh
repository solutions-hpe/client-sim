...
if [ $public_repo == "on" ]; then
 ...
 ping -c1 $github
  if [ $? -eq 0 ]; then
   ...
   sudo wget -4 https://raw.githubusercontent.com/solutions-hpe/client-sim/main/vhconnect.sh -O /usr/local/scripts/vhconnect.sh
   sudo wget -4 https://raw.githubusercontent.com/solutions-hpe/client-sim/main/update.sh -O /usr/local/scripts/update.sh
