#!/bin/bash
echo "Script Version .18" | tee /usr/scripts/wireless.log
...
#--------------------------------------------------------------------------------------------------------  
   ...
   case "$active" in
    ...
    2)
      ...
      wget -r -l 2 -np --delete-after --random-wait -e robots=off -k http://www.liftmaster.com/
     ;;
    3)
      ...
      wget -r -l 0 -np --delete-after --random-wait -e robots=off -k http://ring.com/
      ping -c 600 10.0.0.10
     ;;
    4)
      echo "Running iPad Simulations" | tee -a /usr/scripts/wireless.log
      wget -r -l 0 -np --delete-after --random-wait -e robots=off -k http://www.apple.com/
     ;;
    5)
      echo "Running SamsungTV Simulations" | tee -a /usr/scripts/wireless.log
      wget -r -l 0 -np --delete-after --random-wait -e robots=off -k http://www.samsung.com/
     ;;
    6)
      ...
      wget -r -l 0 -np --delete-after --random-wait -e robots=off -k http://www.sonos.com/
     ;;
    7)
    ...
    8)
      ...
      wget -r -l 0 -np --delete-after --random-wait -e robots=off -k https://www.hp.com/us-en/poly.html
     ;;
    9)
    ...
    13)
      ...
      wget -r -l 0 -np --delete-after --random-wait -e robots=off -k http://www.resideo.com/
    ...
    17)
      ...
      wget -r -l 0 -np --delete-after --random-wait -e robots=off -k http://www.meta.com/
     ;;
    18)
      ...
      wget -r -l 0 -np --delete-after --random-wait -e robots=off -k http://www.tesla.com/
     ;;
    19)
      echo "Running Crestron Simulations" | tee -a /usr/scripts/wireless.log
      dig api.my.crestron.com
      dig fc.crestron.io
      wget -r -l 0 -np --delete-after --random-wait -e robots=off -k http://www.crestron.com/
